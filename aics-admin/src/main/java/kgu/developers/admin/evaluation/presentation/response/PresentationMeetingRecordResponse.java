...
@Builder
public record PresentationMeetingRecordResponse(
    ...
    public static PresentationMeetingRecordResponse from(MeetingRecord meetingRecord) {
        return PresentationMeetingRecordResponse.builder()
