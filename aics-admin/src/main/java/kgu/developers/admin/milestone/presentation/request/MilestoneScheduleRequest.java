...
public record MilestoneScheduleRequest(
        ...
        @Schema(
                description = "제출 마감 시각. PRESENTATION에서는 발표자료 제출 마감 시각이다.",
                example = "2026-09-10T23:59:59",
        ...
        @Schema(
                description = "평가 시작 시각. PRESENTATION에서는 발표 평가 시작 시각이다.",
                example = "2026-09-13T00:00:00"
        )
        LocalDateTime evaluationOpensAt,

        @Schema(
                description = "평가 종료 시각. PRESENTATION에서는 발표 평가 종료 시각이다.",
                example = "2026-09-15T23:59:59"
        )
