...
@Builder
public record SubmissionSubmitterAdminResponse(
        ...
        public static SubmissionSubmitterAdminResponse of(String userId, User user) {
                return SubmissionSubmitterAdminResponse.builder()
                        .userId(userId)
