...
class SecurityConfigTest {
  ...
  private static final String ADMIN_URL = "/api/v1/admin/oop/courses";
  ...
  void admin() throws Exception {
    given(courseFacade.getAllCourses()).willReturn(CourseListResponse.from(List.of()));
