...
@Builder
public record PreSurveyResponseDetailResponse(
    ...
    public static PreSurveyResponseDetailResponse from(PreSurveyResponse response, String userName) {
        return PreSurveyResponseDetailResponse.builder()
            .id(response.getId())
