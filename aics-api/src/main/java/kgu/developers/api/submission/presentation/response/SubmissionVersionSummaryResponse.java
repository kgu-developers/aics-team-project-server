...
@Builder
public record SubmissionVersionSummaryResponse(
    ...
    public static SubmissionVersionSummaryResponse from(SubmissionVersion version) {
        return SubmissionVersionSummaryResponse.builder()
