...
class TeamMemberControllerTest {
	...
	private static final String MEMBERS_URL = "/api/v1/teams/{teamId}/members";
	...
	void getTeamMembers() throws Exception {
		given(teamMemberFacade.getTeamMembers(1L, STUDENT_NUMBER, "김")).willReturn(
			new TeamMemberListResponse(List.of(
